...
CONF_POINTER = "pointer"
CONF_ALPHA_KEYBOARD = "alpha_keyboard"
...
async def to_code(config):
    ...
    # Ohne Zeigegeraet: Maus und absoluter Zeiger fallen aus der
    # HID-Geraetebeschreibung. Android TV wechselt sonst bei jedem Verbinden in
    # den Mausmodus und baut die Oberflaeche neu auf.
    if not config[CONF_POINTER]:
        cg.add_define("ESPIDF_BLE_KB_NO_POINTER")
